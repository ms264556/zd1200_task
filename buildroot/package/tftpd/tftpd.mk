...
DIRECTOR_PATCH_DIR=$(TOPDIR)/../controller/ac/usr/utils/ruckus_patch
DIRECTOR_TFTPD_PATCH=$(DIRECTOR_PATCH_DIR)/patch_tftpd
endif
...
ifeq ($(BR2_PACKAGE_DIRECTOR),y)
ifeq ($(TFTP_HPA_VER),0.40)
	(cd $(TFTP_HPA_DIR); patch -p1 < $(DIRECTOR_TFTPD_PATCH))
endif
endif
