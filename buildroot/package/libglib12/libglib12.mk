...
#
#############################################################
LIBGLIB12_VER=$(strip $(subst ",,$(BR2_PACKAGE_LIBGLIB12_VER)))
LIBGLIB12_SOURCE:=glib-$(LIBGLIB12_VER).tar.gz
LIBGLIB12_SITE:=ftp://ftp.gtk.org/pub/gtk/v1.2
LIBGLIB12_CAT:=zcat
LIBGLIB12_DIR:=$(BUILD_DIR)/glib-$(LIBGLIB12_VER)

ifeq ($(LIBGLIB12_VER),1.2.10)
LIBGLIB12_BINARY:=libglib-1.2.so.0.0.10
endif

ifeq ($(LIBGLIB12_VER),2.28.0)
DEP_TARGET=libiconv
EXTRA_FLAG=--disable-selinux --with-libiconv
endif
...
$(LIBGLIB12_DIR)/.unpacked: $(DL_DIR)/$(LIBGLIB12_SOURCE)
	...
	toolchain/patch-kernel.sh $(LIBGLIB12_DIR) package/libglib12/ \glib-$(LIBGLIB12_VER)-*.patch*
...
libglib12: uclibc $(DEP_TARGET) $(TARGET_DIR)/lib/$(LIBGLIB12_BINARY)
