...
E2FSPROGS_INSTALL_DIR=
ifeq ($(BR2_PACKAGE_E2FSPROG_SYSTEM),y)
E2FSPROGS_INSTALL_DIR+=$(TARGET_DIR)
endif
ifeq ($(BR2_PACKAGE_E2FSPROG_USBTOOL),y)
E2FSPROGS_INSTALL_DIR+=$(USB_TOOL_BUILD_DIR)
endif

ifeq ($(BR2_PACKAGE_E2FSPROG_RESIZER),y)
E2FS_RESIZER=--enable-resizer
else
E2FS_RESIZER=--disable-resizer
endif
...
$(TARGET_DIR)/$(E2FSPROGS_TARGET_BINARY): $(E2FSPROGS_DIR)/$(E2FSPROGS_BINARY)
	for d in $(E2FSPROGS_INSTALL_DIR); do \
		$(MAKE1) PATH=$(TARGET_PATH) DESTDIR=$$d -C $(E2FSPROGS_DIR) install; \
		rm -rf $$d/share/locale $$d/usr/info $$d/usr/man $$d/usr/share/doc; \
		touch -c $$d/$(E2FSPROGS_TARGET_BINARY); \
	done;
...
e2fsprogs-clean:
	for d in $(E2FSPROGS_INSTALL_DIR); do \
		$(MAKE1) DESTDIR=$$d CC=$(TARGET_CC) -C $(E2FSPROGS_DIR) uninstall; \
	done;
