...
#if defined(V54_BSP)
#define __i2c_transfer  i2c_transfer
...
#if defined(V54_BSP)
    vendor = ((vendor & 0xff) << 24) | ((vendor & 0xff00) << 8) |
            ((vendor & 0xff0000) >> 8) | ((vendor & 0xff000000) >> 24);
#endif
...
extern struct i2c_adapter *adap;    // in rksi2c.c
static struct i2c_client *client;
static struct i2c_board_info info = {
   I2C_BOARD_INFO("tpm_i2c_infineon", 0x20),
};

static int __init tpm_tis_i2c_driver_init(void)
{
    int ret=1;
    ...
    ret = i2c_add_driver(&tpm_tis_i2c_driver);
    if (ret != 0) {
...
static void __exit tpm_tis_i2c_driver_exit(void)
{
    //printk("%s: \n", __func__);
    i2c_unregister_device(client);
    i2c_del_driver(&tpm_tis_i2c_driver);
}
module_init(tpm_tis_i2c_driver_init);
module_exit(tpm_tis_i2c_driver_exit);
#endif
