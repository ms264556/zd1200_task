...
#define ATHR_GMAC_ETH_CFG_RXD_DELAY_SHIFT  14
#define ATHR_GMAC_ETH_CFG_RDV_DELAY_SHIFT  16
#define ATHR_GMAC_ETH_CFG_TXD_DELAY_SHIFT  18
#define ATHR_GMAC_ETH_CFG_TEN_DELAY_SHIFT  20
