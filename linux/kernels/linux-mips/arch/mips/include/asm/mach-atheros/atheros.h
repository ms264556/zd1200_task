...
#	include <933x.h>
#elif defined(CONFIG_MACH_AR934x) || defined(CONFIG_MACH_AR934x_MODULE)
#	include <934x.h>
#elif defined(CONFIG_MACH_QCA955x) || defined(CONFIG_MACH_QCA955x_MODULE)
/*
...
{
	unsigned int cs;
#if defined(CONFIG_MACH_AR934x) || defined(CONFIG_MACH_QCA955x) || defined(CONFIG_MACH_QCA955x_MODULE) || defined(CONFIG_MACH_AR934x_MODULE)
	ath_spi_down();
	ath_spi_init();
	ath_spi_enable_soft_access();
	cs = ath_reg_rd(ATH_SPI_WRITE) & ATH_SPI_CS_DIS;
